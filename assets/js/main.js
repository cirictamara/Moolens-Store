...
window.onscroll = function() { 
    scrollFunction(window.matchMedia("(min-width: 992px)")); 
    scrollFunction(window.matchMedia("(min-width: 501px and max-width: 991px)")); 
    scrollFunction(window.matchMedia("(max-width: 500px)")); 
};
...
function scrollFunction(x) {
	...
	if (document.body.scrollTop > 50 || document.documentElement.scrollTop > 50)
        document.getElementById("logo").style.cssText = "transform: rotate(15deg); top: 0;";
    else
        document.getElementById("logo").style.cssText = "transform: rotate(-20deg); top: 35px;";

    if (window.matchMedia("(min-width: 992px)").matches) {
        if (document.body.scrollTop > 50 || document.documentElement.scrollTop > 50) {
            document.getElementById("logo").style.width = "115px;";
            document.getElementById("header").style.padding = "10px 80px 20px 50px;";
        } 
        else {
            document.getElementById("logo").style.width = "160px;";
            document.getElementById("header").style.padding = "10px 70px 10px 30px;";
        }
    }
    else if (window.matchMedia("(min-width: 501px and max-width: 991px)").matches)
        if (document.body.scrollTop > 50 || document.documentElement.scrollTop > 50) {
            document.getElementById("logo").style.width = "115px;";
        ...
        if (document.body.scrollTop > 50 || document.documentElement.scrollTop > 50) {
            ...
            document.querySelector(".navbar-toggler").style.top = "15px;";
        } 
        else {
...
function createSlides() {
    ...
    for (let i = 0; i < slideContents.length; i++) {
        ...
        setAttributes([img_1], ["class", "img-1", "src", `assets/img/${slideImages[i].img_1.src}`, "alt", slideImages[i].img_1.alt]);

        let img_2 = document.createElement("img");
        setAttributes([img_2], ["class", "img-2 d-none", "src", `assets/img/${slideImages[i].img_2.src}`, "alt", slideImages[i].img_2.alt]);

        let img_3 = document.createElement("img");
        setAttributes([img_3], ["class", "img-3 d-none", "src", `assets/img/${slideImages[i].img_3.src}`, "alt", slideImages[i].img_3.alt]);
